      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-2 text-sm font-mono">
            {[
              "CHAPA", "NOME", "FUNÇÃO", "SALARIO ATUAL", "ADICIONAL", "ENCARGOS", "CPF", "SEXO",
          ...
          <p className="mt-4 text-xs text-muted-foreground">
            ...
            • ENCARGOS é o valor já totalizado de plano saúde + odontológico + seguro de vida, quando a planilha não tem essas colunas separadas — soma no "Encargos" do custo total<br />
            ...
            • A coluna SITUAÇÃO aceita: ATIVO, DESLIGADO, AFASTADO, FÉRIAS, LICENÇA, ou os códigos de uma letra A, D, F<br />
