...
interface CarteiraItem { name: string; total: number; media: number; count: number }
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={260}>
            <BarChart data={carteiraData} margin={{ top: 4, right: 8, bottom: 40, left: 8 }}>
              ...
              <Tooltip formatter={(v: number) => fmt(v)} labelFormatter={(l) => `Carteira: ${l}`} />
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={260}>
            <BarChart data={funcaoData} layout="vertical" margin={{ top: 4, right: 32, bottom: 4, left: 8 }}>
              ...
              <Tooltip formatter={(v: number) => fmt(v)} labelFormatter={(l) => `Função: ${l}`} />
